...
let MyHomePage1 = new YoutubHomePage("Parallax on the web",["Parallax1","Parallax2","Parallax3","Parallax4","Parallax5" ],"MostWatchVideoOnYouTube","LastWatchVideo")
...
let MyHomePage2 = new YoutubHomePage("Parallax on the web",["episode1","episode2","episode3","episode4","episode5"],"MostWatchVideoOnYouTube","LastWatchVideo","Dev Tips" ,["Likevideo1","Likevideo2","Likevideo3","Likevideo4"])
...
let Channel = new channelOne ("Parallax on the web Series",["video1","vidoe2","..."],"1.3m","PlayListName")
...
let MychanellDetalis = new MyuploadVideo ("social",["commet1","commet2","commet3","commet4","commet5"],12543)
